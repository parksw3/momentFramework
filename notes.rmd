...
```{r plot0, fig.width = 5, fig.height=5}
plot(k3/k2, type = "l")
```
...
```{r plot2, fig.width = 5, fig.height=5}
r2 <- k3/k2
...
Linear extrapolation of the $\kappa_3/\kappa_2$ ratio approximates the prevalence trajectory better sice it matches the initial $\kappa$ trajectory but it doesn't approximate $\kappa$ so well near the equilibrium....
